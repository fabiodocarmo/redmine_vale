...
RAW
  ...
  def test_link_to_attachment
    a = Attachment.find(3)
    assert_equal '<a target="_blank" href="/attachments/3/logo.gif">logo.gif</a>',
      link_to_attachment(a)
    assert_equal '<a target="_blank" href="/attachments/3/logo.gif">Text</a>',
      link_to_attachment(a, :text => 'Text')
    result = link_to("logo.gif", "/attachments/3/logo.gif", :class => "foo", target: "_blank")
    assert_equal result,
      link_to_attachment(a, :class => 'foo')
    assert_equal '<a target="_blank" href="/attachments/download/3/logo.gif">logo.gif</a>',
      link_to_attachment(a, :download => true)
    assert_equal '<a target="_blank" href="http://test.host/attachments/3/logo.gif">logo.gif</a>',
