...
class MailerTest < ActiveSupport::TestCase
  ...
  def test_reminders
    ...
    assert_equal '1 issue(s) estimated for the next 42 days', mail.subject
  end
      ...
      with_settings :plain_text_mail => 0 do
        ...
        assert_select_email do
          assert_select ".header" do
            assert_select "strong", :text => "This is an automatic notification from Service Center. Please, don't reply to this message."
          end
        end
      end
