  ...
  def test_project_menu_with_additional_menu_items
    ...
    assert_no_difference 'Redmine::MenuManager.items(:project_menu).size' do
      Redmine::MenuManager.map :project_menu do |menu|
        ...
        menu.push :bar, { :controller => 'projects', :action => 'show' }, :before => :issues
      ...
      assert_select 'div#main-menu ul' do
        ...
        assert_select 'li:nth-child(3) a.bar[href=?]', '/projects/ecookbook', :text => 'Bar'
        assert_select 'li:nth-child(4) a.hello[href=?]', '/projects/ecookbook', :text => 'ECOOKBOOK'
        assert_select 'li:nth-child(5) a', :text => 'Issues'
      end
