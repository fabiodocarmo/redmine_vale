...
class Group < Principal
  ...
  def user_added(user)
    ...
    Audit.create!({klazz_name: self.class.to_s, col_name: :user, action: :add, value_was: nil, value: user.id, resource_id: self.id})
  end
  ...
  def user_removed(user)
    ...
    Audit.create!({klazz_name: self.class.to_s, col_name: :user, action: :remove, value_was: user.id, value: nil, resource_id: self.id})
  end
