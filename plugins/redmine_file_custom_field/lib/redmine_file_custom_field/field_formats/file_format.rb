  ...
  module FieldFormat
    class FileFormat < Redmine::FieldFormat::Base
      ...
      def formatted_custom_value(view, custom_value, html=false)
        custom_value = CustomValue.find_by_customized_type_and_customized_id_and_custom_field_id(
            custom_value.customized.class.name, custom_value.customized.id, custom_value.custom_field.id
        )
