...
module DefaultCustomQuery
  module IssuesControllerPatch
    ...
    def with_default_query
      case
      #VISAGIO: Linha adicionada
      when params[:format].present?
    ...
    def retrieve_query_from_session_with_default_custom_query
      ...
      #VISAGIO: Linha acima substituída pela abaixo
      if default_query_module_enabled? || params[:without_default]
        if session[:query]
    ...
    def apply_default_query!
      ...
      if default_query
        ...
        #VISAGIO: Redirect adicionado
        redirect_to issues_path(params)
      end
    end
