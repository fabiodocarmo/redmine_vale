...
CustomField.send(:include, RedmineElasticsearch::Patches::CustomFieldPatch) unless CustomField.included_modules.include? RedmineElasticsearch::Patches::CustomFieldPatch
